...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attendee.datetime_created'
        db.add_column('events_attendee', 'datetime_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 6, 19, 17, 12, 42, 923132), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attendee.datetime_created'
        db.delete_column('events_attendee', 'datetime_created')
