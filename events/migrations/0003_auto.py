...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field recruiter on 'Event'
        db.delete_table('events_event_recruiter')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field recruiter on 'Event'
        db.create_table('events_event_recruiter', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('recruiter', models.ForeignKey(orm['employer.recruiter'], null=False))
        ))
        db.create_unique('events_event_recruiter', ['event_id', 'recruiter_id'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '42'}),
            'recruiters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['employer.Recruiter']", 'symmetrical': 'False'}),
            'rsvp_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'rsvp_message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'rsvps': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['student.Student']", 'null': 'True', 'symmetrical': 'False'}),
