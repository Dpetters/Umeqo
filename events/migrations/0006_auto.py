...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field employers on 'Event'
        db.create_table('events_event_employers', (
        ...
        db.create_unique('events_event_employers', ['event_id', 'recruiter_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field employers on 'Event'
        db.delete_table('events_event_employers')
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 46, 31, 386000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 46, 31, 386000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'events.event': {
            ...
            'employers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['employer.Recruiter']", 'symmetrical': 'False'}),
