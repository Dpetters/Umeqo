...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeaturedEvent.event'
        db.alter_column('events_featuredevent', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'FeaturedEvent.event'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedEvent.event' and its values cannot be restored.")
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 3, 6, 19, 384000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 3, 6, 19, 384000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.edit': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 3, 6, 19, 385000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 3, 6, 19, 455000)'}),
