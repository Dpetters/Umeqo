...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RSVP.datetime_created'
        db.add_column('events_rsvp', 'datetime_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 6, 19, 22, 54, 17, 28658), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RSVP.datetime_created'
        db.delete_column('events_rsvp', 'datetime_created')
