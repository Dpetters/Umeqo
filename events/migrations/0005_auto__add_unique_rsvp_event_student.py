...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RSVP', fields ['event', 'student']
        db.create_unique('events_rsvp', ['event_id', 'student_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RSVP', fields ['event', 'student']
        db.delete_unique('events_rsvp', ['event_id', 'student_id'])
