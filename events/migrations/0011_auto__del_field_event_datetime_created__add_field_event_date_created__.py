...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.datetime_created'
        db.delete_column('events_event', 'datetime_created')

        # Adding field 'Event.date_created'
        db.add_column('events_event', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 2, 19, 6, 49, 320000), auto_now_add=True, blank=True), keep_default=False)

        # Removing M2M table for field recruiters on 'Event'
        db.delete_table('events_event_recruiters')
        ...
        db.alter_column('events_event', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Event.datetime_created'
        raise RuntimeError("Cannot reverse this migration. 'Event.datetime_created' and its values cannot be restored.")

        # Deleting field 'Event.date_created'
        db.delete_column('events_event', 'date_created')

        # Adding M2M table for field recruiters on 'Event'
        db.create_table('events_event_recruiters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('recruiter', models.ForeignKey(orm['employer.recruiter'], null=False))
        ))
        db.create_unique('events_event_recruiters', ['event_id', 'recruiter_id'])
        ...
        # Changing field 'Event.owner'
        db.alter_column('events_event', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.Recruiter']))
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 19, 6, 49, 319000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 19, 6, 49, 319000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.edit': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 19, 6, 49, 320000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'events.event': {
            ...
            'attending_employers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['employer.Employer']", 'null': 'True', 'blank': 'True'}),
