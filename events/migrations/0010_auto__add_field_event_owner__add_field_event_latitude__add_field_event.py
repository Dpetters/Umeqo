...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['employer.Recruiter']), keep_default=False)

        # Adding field 'Event.latitude'
        db.add_column('events_event', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Event.longitude'
        db.add_column('events_event', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.owner'
        db.delete_column('events_event', 'owner_id')

        # Deleting field 'Event.latitude'
        db.delete_column('events_event', 'latitude')

        # Deleting field 'Event.longitude'
        db.delete_column('events_event', 'longitude')
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 22, 54, 3, 265000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 22, 54, 3, 265000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'events.event': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '42'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['employer.Recruiter']"}),
            'recruiters': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'modified_events'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['employer.Recruiter']"}),
