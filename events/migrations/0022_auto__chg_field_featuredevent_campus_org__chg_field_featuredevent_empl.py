...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeaturedEvent.campus_org'
        db.alter_column('events_featuredevent', 'campus_org_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campus_org.CampusOrg'], null=True))

        # Changing field 'FeaturedEvent.employer'
        db.alter_column('events_featuredevent', 'employer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.Employer'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'FeaturedEvent.campus_org'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedEvent.campus_org' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'FeaturedEvent.employer'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedEvent.employer' and its values cannot be restored.")
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 15, 41, 26, 200000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 15, 41, 26, 200000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 15, 41, 26, 217000)'}),
