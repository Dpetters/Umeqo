...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.short_slug'
        db.add_column('events_event', 'short_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True), keep_default=False)

        # Changing field 'Event.name'
        db.alter_column('events_event', 'name', self.gf('django.db.models.fields.CharField')(max_length=85))


    def backwards(self, orm):
        
        # Deleting field 'Event.short_slug'
        db.delete_column('events_event', 'short_slug')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 15, 1, 10, 620220)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 15, 1, 10, 620145)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.edit': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 15, 1, 10, 620572)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'events.event': {
            ...
            'short_slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'db_index': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 15, 1, 10, 644360)'}),
