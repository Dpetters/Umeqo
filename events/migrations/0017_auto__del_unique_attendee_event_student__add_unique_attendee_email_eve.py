...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Attendee', fields ['event', 'student']
        db.delete_unique('events_attendee', ['event_id', 'student_id'])

        # Adding unique constraint on 'Attendee', fields ['email', 'event']
        db.create_unique('events_attendee', ['email', 'event_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Attendee', fields ['email', 'event']
        db.delete_unique('events_attendee', ['email', 'event_id'])

        # Adding unique constraint on 'Attendee', fields ['event', 'student']
        db.create_unique('events_attendee', ['event_id', 'student_id'])
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 18, 48, 29, 56000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 18, 48, 29, 55000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 18, 48, 29, 78000)'}),
