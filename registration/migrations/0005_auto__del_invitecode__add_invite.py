...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('registration_invitecode')
        ...
        db.create_table('registration_invite', (
            ...
            ('acceptor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accepted_invite_set', unique=True, null=True, to=orm['auth.User'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('registration_invitecode', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 12, 11, 50, 13, 837000), auto_now_add=True, blank=True)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 12, 11, 50, 13, 837000), auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('registration', ['InviteCode'])
    ...
    models = {
        ...
        'registration.interestedperson': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 12, 19, 51, 35, 123000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 12, 19, 51, 35, 123000)', 'auto_now': 'True', 'blank': 'True'}),
            'summer_plans': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'registration.invite': {
            'Meta': {'object_name': 'Invite'},
            'acceptor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'accepted_invite_set'", 'unique': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 12, 19, 51, 35, 123000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '12', 'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 12, 19, 51, 35, 123000)', 'auto_now': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_invite_set'", 'to': "orm['auth.User']"})
        },
