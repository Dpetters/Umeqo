...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InterestedPerson.final'
        db.add_column('registration_interestedperson', 'final', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InterestedPerson.final'
        db.delete_column('registration_interestedperson', 'final')
    ...
    models = {
        ...
        'registration.interestedperson': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 17, 21, 4, 41, 346000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 17, 21, 4, 41, 346000)', 'auto_now': 'True', 'blank': 'True'}),
