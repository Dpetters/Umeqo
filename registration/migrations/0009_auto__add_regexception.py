...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registration_regexception', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 9, 2, 11, 36, 3, 196000), auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        'registration.interestedperson': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 2, 11, 36, 3, 196000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 2, 11, 36, 3, 196000)', 'auto_now': 'True', 'blank': 'True'}),
