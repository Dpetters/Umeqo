...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('subscription_subscription', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Subscription.id'
        db.alter_column('subscription_subscription', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 36, 29, 922000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 36, 29, 922000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 36, 29, 923000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 36, 29, 938000)'}),
