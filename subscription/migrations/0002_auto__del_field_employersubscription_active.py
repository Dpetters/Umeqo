...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EmployerSubscription.active'
        db.delete_column('subscription_employersubscription', 'active')


    def backwards(self, orm):
        
        # Adding field 'EmployerSubscription.active'
        db.add_column('subscription_employersubscription', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 8, 13, 46, 7, 420000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 8, 13, 46, 7, 420000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 8, 13, 46, 7, 441000)'}),
