...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('subscription_transaction', 'employer', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['employer.Employer']), keep_default=False)
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 20, 55, 36, 420000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 20, 55, 36, 420000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 20, 55, 36, 439000)'}),
        ...
        'subscription.transaction': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '64', 'decimal_places': '2'}),
