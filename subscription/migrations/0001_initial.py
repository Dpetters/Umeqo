...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subscription_employersubscription', (
            ...
            ('subscription', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['subscription.Subscription'], unique=True)),
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 20, 28, 11, 151000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 20, 28, 11, 151000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 20, 28, 11, 173000)'}),
