...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'EmployerSubscription', fields ['subscription']
        db.delete_unique('subscription_employersubscription', ['subscription_id'])

        # Changing field 'EmployerSubscription.subscription'
        db.alter_column('subscription_employersubscription', 'subscription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subscription.Subscription']))


    def backwards(self, orm):
        
        # Changing field 'EmployerSubscription.subscription'
        db.alter_column('subscription_employersubscription', 'subscription_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['subscription.Subscription'], unique=True))

        # Adding unique constraint on 'EmployerSubscription', fields ['subscription']
        db.create_unique('subscription_employersubscription', ['subscription_id'])
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 10, 54, 35, 807000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 10, 54, 35, 807000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 10, 54, 35, 808000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 10, 54, 35, 824000)'}),
