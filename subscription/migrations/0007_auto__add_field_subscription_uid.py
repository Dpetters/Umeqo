...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.uid'
        db.add_column('subscription_subscription', 'uid', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.uid'
        db.delete_column('subscription_subscription', 'uid')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 38, 31, 353000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 38, 31, 353000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 38, 31, 368000)'}),
