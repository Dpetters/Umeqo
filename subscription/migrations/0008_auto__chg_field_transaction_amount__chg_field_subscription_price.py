...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('subscription_transaction', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Subscription.price'
        db.alter_column('subscription_subscription', 'price', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Transaction.amount'
        db.alter_column('subscription_transaction', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=64, decimal_places=2))

        # Changing field 'Subscription.price'
        db.alter_column('subscription_subscription', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=64, decimal_places=2))
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 17, 3, 231000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 17, 3, 231000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 17, 3, 232000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 17, 3, 276000)'}),
