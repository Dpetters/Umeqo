...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EmployerUser.active'
        db.delete_column('employer_employeruser', 'active')

        # Adding field 'EmployerUser.is_active'
        db.add_column('employer_employeruser', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'EmployerUser.active'
        db.add_column('employer_employeruser', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'EmployerUser.is_active'
        db.delete_column('employer_employeruser', 'is_active')
