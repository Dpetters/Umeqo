...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.slugg'
        db.add_column('employer_employer', 'slugg', self.gf('django.db.models.fields.CharField')(default='sample', max_length=20), keep_default=False)
    ...
    models = {
        ...
        'employer.employer': {
            ...
            'slugg': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
