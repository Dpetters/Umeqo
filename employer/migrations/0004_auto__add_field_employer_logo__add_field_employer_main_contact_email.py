...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('employer_employer', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Employer.main_contact_email'
        db.add_column('employer_employer', 'main_contact_email', self.gf('django.db.models.fields.EmailField')(default='sample@sampleemployer.com', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employer.logo'
        db.delete_column('employer_employer', 'logo')
