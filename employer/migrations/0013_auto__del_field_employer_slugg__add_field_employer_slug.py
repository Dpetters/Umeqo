...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Employer.slugg'
        db.delete_column('employer_employer', 'slugg')

        # Adding field 'Employer.slug'
        db.add_column('employer_employer', 'slug', self.gf('django.db.models.fields.CharField')(default='sample', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Employer.slugg'
        raise RuntimeError("Cannot reverse this migration. 'Employer.slugg' and its values cannot be restored.")

        # Deleting field 'Employer.slug'
        db.delete_column('employer_employer', 'slug')
