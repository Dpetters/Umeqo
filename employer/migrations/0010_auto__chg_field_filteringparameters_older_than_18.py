...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilteringParameters.older_than_18'
        db.alter_column('employer_filteringparameters', 'older_than_18', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'FilteringParameters.older_than_18'
        db.alter_column('employer_filteringparameters', 'older_than_18', self.gf('django.db.models.fields.BooleanField')())
