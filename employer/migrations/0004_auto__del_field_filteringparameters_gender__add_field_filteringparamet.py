...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FilteringParameters.gender'
        db.delete_column('employer_filteringparameters', 'gender')

        # Adding field 'FilteringParameters.genders'
        db.add_column('employer_filteringparameters', 'genders', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Removing M2M table for field ethnicity on 'FilteringParameters'
        db.delete_table('employer_filteringparameters_ethnicity')

        # Adding M2M table for field ethnicities on 'FilteringParameters'
        db.create_table('employer_filteringparameters_ethnicities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('filteringparameters', models.ForeignKey(orm['employer.filteringparameters'], null=False)),
            ('ethnicity', models.ForeignKey(orm['core.ethnicity'], null=False))
        ))
        db.create_unique('employer_filteringparameters_ethnicities', ['filteringparameters_id', 'ethnicity_id'])


    def backwards(self, orm):
        
        # Adding field 'FilteringParameters.gender'
        db.add_column('employer_filteringparameters', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Deleting field 'FilteringParameters.genders'
        db.delete_column('employer_filteringparameters', 'genders')

        # Adding M2M table for field ethnicity on 'FilteringParameters'
        db.create_table('employer_filteringparameters_ethnicity', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('filteringparameters', models.ForeignKey(orm['employer.filteringparameters'], null=False)),
            ('ethnicity', models.ForeignKey(orm['core.ethnicity'], null=False))
        ))
        db.create_unique('employer_filteringparameters_ethnicity', ['filteringparameters_id', 'ethnicity_id'])

        # Removing M2M table for field ethnicities on 'FilteringParameters'
        db.delete_table('employer_filteringparameters_ethnicities')
    ...
    models = {
        ...
        'employer.employerpreferences': {
            'Meta': {'object_name': 'EmployerPreferences'},
        ...
        'employer.employeruser': {
            'Meta': {'object_name': 'EmployerUser'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'default_filtering_parameters': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['employer.FilteringParameters']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'employer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['employer.Employer']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'preferences': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['employer.EmployerPreferences']", 'unique': 'True'}),
            'statistics': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['employer.EmployerStatistics']", 'unique': 'True'}),
        ...
        'employer.filteringparameters': {
            ...
            'ethnicities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['core.Ethnicity']", 'null': 'True', 'blank': 'True'}),
            'genders': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
        ...
        'employer.resumebook': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'employer_user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['employer.EmployerUser']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
