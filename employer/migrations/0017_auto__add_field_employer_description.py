...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('employer_employer', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employer.description'
        db.delete_column('employer_employer', 'description')
