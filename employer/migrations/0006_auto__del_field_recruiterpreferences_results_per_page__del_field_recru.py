...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RecruiterPreferences.results_per_page'
        db.delete_column('employer_recruiterpreferences', 'results_per_page')

        # Deleting field 'RecruiterPreferences.email_on_rsvp'
        db.delete_column('employer_recruiterpreferences', 'email_on_rsvp')

        # Deleting field 'RecruiterPreferences.default_student_ordering'
        db.delete_column('employer_recruiterpreferences', 'default_student_ordering')

        # Adding field 'RecruiterPreferences.email_on_rsvp_to_public_event'
        db.add_column('employer_recruiterpreferences', 'email_on_rsvp_to_public_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'RecruiterPreferences.email_on_rsvp_to_private_event'
        db.add_column('employer_recruiterpreferences', 'email_on_rsvp_to_private_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'RecruiterPreferences.default_results_per_page'
        db.add_column('employer_recruiterpreferences', 'default_results_per_page', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10), keep_default=False)

        # Adding field 'RecruiterPreferences.default_result_ordering'
        db.add_column('employer_recruiterpreferences', 'default_result_ordering', self.gf('django.db.models.fields.CharField')(default='relevancy', max_length=42), keep_default=False)

        # Adding field 'EmployerStudentComment.last_updated'
        db.add_column('employer_employerstudentcomment', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 19, 22, 31, 42, 843000), auto_now=True, blank=True), keep_default=False)

        # Adding field 'EmployerStudentComment.date_created'
        db.add_column('employer_employerstudentcomment', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 19, 22, 31, 42, 843000), auto_now_add=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RecruiterPreferences.results_per_page'
        db.add_column('employer_recruiterpreferences', 'results_per_page', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10), keep_default=False)

        # Adding field 'RecruiterPreferences.email_on_rsvp'
        db.add_column('employer_recruiterpreferences', 'email_on_rsvp', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'RecruiterPreferences.default_student_ordering'
        db.add_column('employer_recruiterpreferences', 'default_student_ordering', self.gf('django.db.models.fields.CharField')(default='relevancy', max_length=42), keep_default=False)

        # Deleting field 'RecruiterPreferences.email_on_rsvp_to_public_event'
        db.delete_column('employer_recruiterpreferences', 'email_on_rsvp_to_public_event')

        # Deleting field 'RecruiterPreferences.email_on_rsvp_to_private_event'
        db.delete_column('employer_recruiterpreferences', 'email_on_rsvp_to_private_event')

        # Deleting field 'RecruiterPreferences.default_results_per_page'
        db.delete_column('employer_recruiterpreferences', 'default_results_per_page')

        # Deleting field 'RecruiterPreferences.default_result_ordering'
        db.delete_column('employer_recruiterpreferences', 'default_result_ordering')

        # Deleting field 'EmployerStudentComment.last_updated'
        db.delete_column('employer_employerstudentcomment', 'last_updated')

        # Deleting field 'EmployerStudentComment.date_created'
        db.delete_column('employer_employerstudentcomment', 'date_created')
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 31, 42, 843000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 31, 42, 843000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'employer.recruiterpreferences': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 31, 42, 843000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'default_result_ordering': ('django.db.models.fields.CharField', [], {'default': "'relevancy'", 'max_length': '42'}),
            'default_results_per_page': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '10'}),
