...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'StudentComment', fields ['student']
        db.delete_unique('employer_studentcomment', ['student_id'])

        # Changing field 'StudentComment.student'
        db.alter_column('employer_studentcomment', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.Student']))


    def backwards(self, orm):
        
        # Changing field 'StudentComment.student'
        db.alter_column('employer_studentcomment', 'student_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['student.Student'], unique=True))

        # Adding unique constraint on 'StudentComment', fields ['student']
        db.create_unique('employer_studentcomment', ['student_id'])
