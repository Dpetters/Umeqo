...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.visible'
        db.add_column('employer_employer', 'visible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Employer.logo'
        db.alter_column('employer_employer', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Employer.slug'
        db.alter_column('employer_employer', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=20, unique=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Employer.visible'
        db.delete_column('employer_employer', 'visible')

        # User chose to not deal with backwards NULL issues for 'Employer.logo'
        raise RuntimeError("Cannot reverse this migration. 'Employer.logo' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Employer.slug'
        raise RuntimeError("Cannot reverse this migration. 'Employer.slug' and its values cannot be restored.")
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 9, 55, 42, 69000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 9, 55, 42, 69000)', 'auto_now': 'True', 'blank': 'True'}),
