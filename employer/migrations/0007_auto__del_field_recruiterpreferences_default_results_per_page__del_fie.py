...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecruiterPreferences.default_student_results_per_page'
        db.add_column('employer_recruiterpreferences', 'default_student_results_per_page', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10), keep_default=False)

        # Adding field 'RecruiterPreferences.default_student_result_ordering'
        db.add_column('employer_recruiterpreferences', 'default_student_result_ordering', self.gf('django.db.models.fields.CharField')(default='relevancy', max_length=42), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RecruiterPreferences.default_student_results_per_page'
        db.delete_column('employer_recruiterpreferences', 'default_student_results_per_page')

        # Deleting field 'RecruiterPreferences.default_student_result_ordering'
        db.delete_column('employer_recruiterpreferences', 'default_student_result_ordering')
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 36, 39, 83000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 36, 39, 83000)', 'auto_now': 'True', 'blank': 'True'}),
