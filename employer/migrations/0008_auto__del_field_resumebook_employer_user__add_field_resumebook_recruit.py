...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ResumeBook.employer_user'
        db.delete_column('employer_resumebook', 'employer_user_id')

        # Adding field 'ResumeBook.recruiter'
        db.add_column('employer_resumebook', 'recruiter', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['employer.Recruiter'], unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ResumeBook.employer_user'
        db.add_column('employer_resumebook', 'employer_user', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['employer.Recruiter'], unique=True), keep_default=False)

        # Deleting field 'ResumeBook.recruiter'
        db.delete_column('employer_resumebook', 'recruiter_id')
