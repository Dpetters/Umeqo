...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentComment.recruiter'
        db.delete_column('employer_studentcomment', 'recruiter_id')

        # Adding field 'StudentComment.employer'
        db.add_column('employer_studentcomment', 'employer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['employer.Employer']), keep_default=False)

        # Adding unique constraint on 'StudentComment', fields ['student', 'employer']
        db.create_unique('employer_studentcomment', ['student_id', 'employer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StudentComment', fields ['student', 'employer']
        db.delete_unique('employer_studentcomment', ['student_id', 'employer_id'])

        # User chose to not deal with backwards NULL issues for 'StudentComment.recruiter'
        raise RuntimeError("Cannot reverse this migration. 'StudentComment.recruiter' and its values cannot be restored.")

        # Deleting field 'StudentComment.employer'
        db.delete_column('employer_studentcomment', 'employer_id')
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 21, 52, 33, 471000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 21, 52, 33, 471000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'employer.studentcomment': {
            'Meta': {'unique_together': "(('employer', 'student'),)", 'object_name': 'StudentComment'},
