...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FilteringParameters.citizen'
        db.delete_column('employer_filteringparameters', 'citizen')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FilteringParameters.citizen'
        db.add_column('employer_filteringparameters', 'citizen', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
