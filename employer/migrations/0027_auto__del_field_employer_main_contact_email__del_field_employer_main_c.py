...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Employer.main_contact_email'
        db.delete_column('employer_employer', 'main_contact_email')

        # Deleting field 'Employer.main_contact'
        db.delete_column('employer_employer', 'main_contact')

        # Deleting field 'Employer.main_contact_phone'
        db.delete_column('employer_employer', 'main_contact_phone')


    def backwards(self, orm):
        
        # Adding field 'Employer.main_contact_email'
        db.add_column('employer_employer', 'main_contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)

        # Adding field 'Employer.main_contact'
        db.add_column('employer_employer', 'main_contact', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Employer.main_contact_phone'
        db.add_column('employer_employer', 'main_contact_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 4, 14, 18, 5, 131000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 4, 14, 18, 5, 131000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 4, 14, 18, 5, 164000)'}),
