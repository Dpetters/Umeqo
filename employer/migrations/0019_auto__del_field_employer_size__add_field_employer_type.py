...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.type'
        db.add_column('employer_employer', 'type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Employer.size'
        db.add_column('employer_employer', 'size', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Deleting field 'Employer.type'
        db.delete_column('employer_employer', 'type')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 17, 10, 18, 754000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 17, 10, 18, 754000)', 'auto_now': 'True', 'blank': 'True'}),
