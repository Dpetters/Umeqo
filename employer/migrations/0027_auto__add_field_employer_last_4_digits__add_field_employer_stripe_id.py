...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.last_4_digits'
        db.add_column('employer_employer', 'last_4_digits', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)

        # Adding field 'Employer.stripe_id'
        db.add_column('employer_employer', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employer.last_4_digits'
        db.delete_column('employer_employer', 'last_4_digits')

        # Deleting field 'Employer.stripe_id'
        db.delete_column('employer_employer', 'stripe_id')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 20, 51, 49, 28000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 20, 51, 49, 28000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 20, 51, 49, 59000)'}),
