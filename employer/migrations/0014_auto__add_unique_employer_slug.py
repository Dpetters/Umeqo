...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Employer', fields ['slug']
        db.create_unique('employer_employer', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Employer', fields ['slug']
        db.delete_unique('employer_employer', ['slug'])
