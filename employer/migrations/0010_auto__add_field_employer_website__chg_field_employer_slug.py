...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.website'
        db.add_column('employer_employer', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Changing field 'Employer.slug'
        db.alter_column('employer_employer', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=20))

        # Adding index on 'Employer', fields ['slug']
        db.create_index('employer_employer', ['slug'])


    def backwards(self, orm):
        
        # Removing index on 'Employer', fields ['slug']
        db.delete_index('employer_employer', ['slug'])

        # Deleting field 'Employer.website'
        db.delete_column('employer_employer', 'website')

        # Changing field 'Employer.slug'
        db.alter_column('employer_employer', 'slug', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 11, 14, 19, 43, 642000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 11, 14, 19, 43, 642000)', 'auto_now': 'True', 'blank': 'True'}),
