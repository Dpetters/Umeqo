...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.feature_in_monthly_newsletter'
        db.add_column('employer_employer', 'feature_in_monthly_newsletter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding M2M table for field degree_programs on 'StudentFilteringParameters'
        db.create_table('employer_studentfilteringparameters_degree_programs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentfilteringparameters', models.ForeignKey(orm['employer.studentfilteringparameters'], null=False)),
            ('degreeprogram', models.ForeignKey(orm['student.degreeprogram'], null=False))
        ))
        db.create_unique('employer_studentfilteringparameters_degree_programs', ['studentfilteringparameters_id', 'degreeprogram_id'])


    def backwards(self, orm):
        
        # Deleting field 'Employer.feature_in_monthly_newsletter'
        db.delete_column('employer_employer', 'feature_in_monthly_newsletter')
        ...
        # Removing M2M table for field degree_programs on 'StudentFilteringParameters'
        db.delete_table('employer_studentfilteringparameters_degree_programs')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 18, 24, 19, 687000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 18, 24, 19, 687000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'employer.employer': {
            ...
            'feature_in_monthly_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'employer.studentfilteringparameters': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 18, 24, 19, 687000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'degree_programs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['student.DegreeProgram']", 'null': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 18, 24, 20, 312000)'}),
