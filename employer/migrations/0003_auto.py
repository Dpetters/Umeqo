...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field schools on 'StudentFilteringParameters'
        db.create_table('employer_studentfilteringparameters_schools', (
        ...
        db.create_unique('employer_studentfilteringparameters_schools', ['studentfilteringparameters_id', 'school_id'])


    def backwards(self, orm):
        # Removing M2M table for field schools on 'StudentFilteringParameters'
        db.delete_table('employer_studentfilteringparameters_schools')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '42'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.School']", 'null': 'True'}),
        ...
        'employer.employer': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        'employer.studentfilteringparameters': {
            ...
            'schools': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['core.School']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 8, 0, 0)'}),
