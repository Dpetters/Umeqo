...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'StudentComment', fields ['recruiter']
        db.delete_unique('employer_studentcomment', ['recruiter_id'])

        # Changing field 'StudentComment.recruiter'
        db.alter_column('employer_studentcomment', 'recruiter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.Recruiter']))


    def backwards(self, orm):
        
        # Changing field 'StudentComment.recruiter'
        db.alter_column('employer_studentcomment', 'recruiter_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['employer.Recruiter'], unique=True))

        # Adding unique constraint on 'StudentComment', fields ['recruiter']
        db.create_unique('employer_studentcomment', ['recruiter_id'])
    ...
    models = {
        ...
        'employer.studentcomment': {
            'Meta': {'object_name': 'StudentComment'},
