...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employer.main_contact_phone'
        db.alter_column('employer_employer', 'main_contact_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Employer.main_contact_phone'
        raise RuntimeError("Cannot reverse this migration. 'Employer.main_contact_phone' and its values cannot be restored.")
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 28, 12, 52, 53, 932000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 28, 12, 52, 53, 932000)', 'auto_now': 'True', 'blank': 'True'}),
