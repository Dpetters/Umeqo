...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Employer.company_name'
        db.rename_column('employer_employer', 'company_name', 'name')

    def backwards(self, orm):
        
        # Rename field 'Employer.name'
        db.rename_column('employer_employer', 'name', 'company_name')
