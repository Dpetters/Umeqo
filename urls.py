...
urlpatterns += patterns('',
    ...
    (r'^events/32/investment-banking-and-sales-trading-summer-analyst/?rsvp=true', redirect_to, {'url':"/events/32/events/32/investment-banking-and-sales-trading-summer-analys/?rsvp=true"}),
    #(r'^events/32/investment-banking-and-sales-trading-summer-analyst', redirect_to, {'url':"/events/32/"}),
