...
urlpatterns += patterns('',
    ...
    (r'^password/reset/confirm/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$', auth_views.password_reset_confirm, {'set_password_form':SetPasswordForm, 'template_name' : 'password_reset_new.html', 'extra_context': {'login_form':AuthenticationForm}}, 'auth_password_reset_confirm'),
...
urlpatterns += patterns('student.views',
    ...
    (r'^student/create-campus-organization/$', 'student_create_campus_org', {}, 'student_create_campus_org'),
    ...
    (r'^student/account/$', 'student_account', {}, "student_account"),
...
urlpatterns += patterns('employer.views',
    ...
    (r'^employer/account/$', 'employer_account', {}, 'employer_account'),
