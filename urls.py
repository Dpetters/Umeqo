...
urlpatterns += patterns('',
    ...
    (r'^password/reset/$', auth_views.password_reset, {'password_reset_form':PasswordResetForm, 'template_name' : 'password_reset_form.html', 'email_template_name': 'password_reset_email.html', 'extra_context': {'login_form':AuthenticationForm}}, 'password_reset'),
...
urlpatterns += patterns('core.views',
    (r'^500/$', 'handle_500', {}, '500'),
    (r'^404/$', 'handle_404', {}, '404'),
    (r'^403/$', 'handle_403', {}, '403'),
    (r'^$', 'home', {}, 'home'),
