...
urlpatterns += patterns('',
    ...
    (r'^events/7/oliver-wyman-financial-services-management-consulting-information-session-consultant-panel/$', redirect_to, {'url':"/events/7/oliver-wyman-financial-services-management/"}),
    (r'^sbc-bbq/$', redirect_to, {'url':'/events/6/'}),
    (r'^weiss/$', redirect_to, {'url': '/events/9/'}),
