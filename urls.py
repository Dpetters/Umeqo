...
urlpatterns += patterns('core.views',
    ...
    (r'^blog/$', direct_to_template, { 'template' : 'blog.html' }, 'blog'),
...
urlpatterns += patterns('student.views',
    ...
    (r'^student/registration/$', 'student_registration', {}, "student_registration"),
    (r'^student/registration/complete/$', direct_to_template, { 'template' : 'registration_complete.html' }, 'student_registration_complete'),
    (r'^student/activation/complete/$', direct_to_template, { 'template': 'registration/activation_complete.html' }, 'registration_activation_complete'),
    (r'^student/registration/closed/$', direct_to_template, { 'template': 'registration/registration_closed.html' }, 'student_registration_closed'),
