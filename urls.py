...
urlpatterns += patterns('registration.views',
    ...
    (r'^logout/$', 'logout', 
     {'login_url':'/?action=logged-out'}, 'logout'),
...
urlpatterns += patterns('subscription.views',
    ...
    (r'^subscription/(?P<subscription_type>\w+)/cancel/$', 'subscription_cancel', {}, 'subscription_cancel'),
    (r'^subscription/(?P<subscription_type>\w+)/cancel/confirm/$', 'subscription_cancel_confirm', {}, 'subscription_cancel_confirm'),
    (r'^subscriptions/change-payment/$', 'subscription_change_payment', {}, 'subscription_change_payment'),
