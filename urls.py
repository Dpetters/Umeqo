...
urlpatterns += patterns('subscription.views',
    (r'^subscription/checkout/(?P<plan>\w+)/$', 'checkout', {'extra_context': {'stripe_publishable_key': settings.STRIPE_PUBLISHABLE}}, 'checkout'),
    ...
    (r'^payment/change/$', 'payment_change', {'extra_context': {'stripe_publishable_key': settings.STRIPE_PUBLISHABLE}}, 'payment_change'),
