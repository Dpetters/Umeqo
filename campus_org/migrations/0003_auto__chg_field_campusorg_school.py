...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CampusOrg.school'
        db.alter_column('campus_org_campusorg', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School']))

    def backwards(self, orm):

        # Changing field 'CampusOrg.school'
        db.alter_column('campus_org_campusorg', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School'], null=True))
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'school': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['core.School']"}),
