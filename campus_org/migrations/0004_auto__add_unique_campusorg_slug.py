...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CampusOrg', fields ['slug']
        db.create_unique('campus_org_campusorg', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CampusOrg', fields ['slug']
        db.delete_unique('campus_org_campusorg', ['slug'])
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 16, 52, 2, 945000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 16, 52, 2, 945000)', 'auto_now': 'True', 'blank': 'True'}),
