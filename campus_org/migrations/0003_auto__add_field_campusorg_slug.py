...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CampusOrg.slug'
        db.add_column('campus_org_campusorg', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CampusOrg.slug'
        db.delete_column('campus_org_campusorg', 'slug')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 15, 47, 5, 990000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 15, 47, 5, 990000)', 'auto_now': 'True', 'blank': 'True'}),
