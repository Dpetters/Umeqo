...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CampusOrg.description'
        db.alter_column('campus_org_campusorg', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'CampusOrg.description'
        db.alter_column('campus_org_campusorg', 'description', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 8, 15, 28, 14, 442000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 8, 15, 28, 14, 442000)', 'auto_now': 'True', 'blank': 'True'}),
