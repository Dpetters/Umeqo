...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentInvite.code'
        db.add_column('student_studentinvite', 'code', self.gf('django.db.models.fields.CharField')(default='dadda', unique=True, max_length=12), keep_default=False)

        # Adding field 'StudentInvite.used'
        db.add_column('student_studentinvite', 'used', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'StudentInvite.owner'
        db.alter_column('student_studentinvite', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['student.Student']))

        # Changing field 'StudentInvite.id'
        db.alter_column('student_studentinvite', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))


    def backwards(self, orm):
        
        # Deleting field 'StudentInvite.code'
        db.delete_column('student_studentinvite', 'code')

        # Deleting field 'StudentInvite.used'
        db.delete_column('student_studentinvite', 'used')

        # User chose to not deal with backwards NULL issues for 'StudentInvite.owner'
        raise RuntimeError("Cannot reverse this migration. 'StudentInvite.owner' and its values cannot be restored.")

        # Changing field 'StudentInvite.id'
        db.alter_column('student_studentinvite', 'id', self.gf('django.db.models.fields.CharField')(max_length=12, primary_key=True))
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 0, 33, 19, 678000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 0, 33, 19, 678000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.studentinvite': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 0, 33, 19, 678000)', 'auto_now': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_invite_set'", 'null': 'True', 'to': "orm['student.Student']"}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'accepted_invite'", 'unique': 'True', 'null': 'True', 'to': "orm['student.Student']"}),
        ...
        'student.studentpreferences': {
            ...
            'email_on_new_subscribed_employer_event': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 0, 33, 19, 678000)', 'auto_now': 'True', 'blank': 'True'}),
