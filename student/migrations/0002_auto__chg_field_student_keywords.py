...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.keywords'
        db.alter_column('student_student', 'keywords', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Student.keywords'
        raise RuntimeError("Cannot reverse this migration. 'Student.keywords' and its values cannot be restored.")
