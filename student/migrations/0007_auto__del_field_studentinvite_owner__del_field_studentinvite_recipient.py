...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentInvite.owner'
        db.delete_column('student_studentinvite', 'owner_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'StudentInvite.owner'
        db.add_column('student_studentinvite', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_invite_set', null=True, to=orm['student.Student']), keep_default=False)

        # Adding field 'StudentInvite.recipient'
        db.add_column('student_studentinvite', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accepted_invite', unique=True, null=True, to=orm['student.Student'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 16, 6, 42, 621000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 16, 6, 42, 621000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.studentdeactivation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 16, 6, 42, 622000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
