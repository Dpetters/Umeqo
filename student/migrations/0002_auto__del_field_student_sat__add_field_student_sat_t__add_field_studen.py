...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Student.sat'
        db.delete_column('student_student', 'sat')

        # Adding field 'Student.sat_t'
        db.add_column('student_student', 'sat_t', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Student.sat_m'
        db.add_column('student_student', 'sat_m', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Student.sat_v'
        db.add_column('student_student', 'sat_v', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Student.sat_w'
        db.add_column('student_student', 'sat_w', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Student.sat'
        db.add_column('student_student', 'sat', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Student.sat_t'
        db.delete_column('student_student', 'sat_t')

        # Deleting field 'Student.sat_m'
        db.delete_column('student_student', 'sat_m')

        # Deleting field 'Student.sat_v'
        db.delete_column('student_student', 'sat_v')

        # Deleting field 'Student.sat_w'
        db.delete_column('student_student', 'sat_w')
