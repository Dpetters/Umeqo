...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Student.school_year'
        db.delete_column('student_student', 'school_year_id')

        # Deleting field 'Student.school'
        db.delete_column('student_student', 'school_id')


    def backwards(self, orm):
        # Adding field 'Student.school_year'
        db.add_column('student_student', 'school_year',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SchoolYear'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Student.school'
        db.add_column('student_student', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 30, 0, 0)'}),
