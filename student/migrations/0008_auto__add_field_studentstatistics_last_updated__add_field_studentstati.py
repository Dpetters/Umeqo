...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentStatistics.last_updated'
        db.add_column('student_studentstatistics', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 7, 7, 18, 31, 33, 908000), blank=True), keep_default=False)

        # Adding field 'StudentStatistics.date_created'
        db.add_column('student_studentstatistics', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 7, 18, 32, 4, 990000), blank=True), keep_default=False)

        # Adding field 'StudentPreferences.last_updated'
        db.add_column('student_studentpreferences', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 7, 7, 18, 32, 52, 25000), blank=True), keep_default=False)

        # Adding field 'StudentPreferences.date_created'
        db.add_column('student_studentpreferences', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 7, 18, 32, 58, 685000), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudentStatistics.last_updated'
        db.delete_column('student_studentstatistics', 'last_updated')

        # Deleting field 'StudentStatistics.date_created'
        db.delete_column('student_studentstatistics', 'date_created')

        # Deleting field 'StudentPreferences.last_updated'
        db.delete_column('student_studentpreferences', 'last_updated')

        # Deleting field 'StudentPreferences.date_created'
        db.delete_column('student_studentpreferences', 'date_created')
