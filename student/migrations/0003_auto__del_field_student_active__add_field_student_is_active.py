...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('student_student', 'active')

        # Adding field 'Student.is_active'
        db.add_column('student_student', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Student.active'
        db.add_column('student_student', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Student.is_active'
        db.delete_column('student_student', 'is_active')
