...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentPreferences.email_on_new_event'
        db.delete_column('student_studentpreferences', 'email_on_new_event')

        # Adding field 'StudentPreferences.email_on_new_subscribed_employer_event'
        db.add_column('student_studentpreferences', 'email_on_new_subscribed_employer_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'StudentPreferences.email_on_new_event'
        db.add_column('student_studentpreferences', 'email_on_new_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'StudentPreferences.email_on_new_subscribed_employer_event'
        db.delete_column('student_studentpreferences', 'email_on_new_subscribed_employer_event')
    ...
    models = {
        ...
        'core.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 36, 49, 277000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 22, 36, 49, 277000)', 'auto_now': 'True', 'blank': 'True'}),
