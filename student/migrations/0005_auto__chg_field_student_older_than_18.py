...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.older_than_18'
        db.alter_column('student_student', 'older_than_18', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'Student.older_than_18'
        db.alter_column('student_student', 'older_than_18', self.gf('django.db.models.fields.BooleanField')())
