...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Student.citizen'
        db.delete_column('student_student', 'citizen')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Student.citizen'
        db.add_column('student_student', 'citizen', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
