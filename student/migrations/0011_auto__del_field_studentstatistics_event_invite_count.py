...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentStatistics.event_invite_count'
        db.delete_column('student_studentstatistics', 'event_invite_count')


    def backwards(self, orm):
        
        # Adding field 'StudentStatistics.event_invite_count'
        db.add_column('student_studentstatistics', 'event_invite_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 8, 14, 47, 951000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 8, 14, 47, 950000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 8, 14, 47, 972000)'}),
