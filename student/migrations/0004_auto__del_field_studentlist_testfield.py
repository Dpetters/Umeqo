...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentList.testfield'
        db.delete_column('student_studentlist', 'testfield')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'StudentList.testfield'
        raise RuntimeError("Cannot reverse this migration. 'StudentList.testfield' and its values cannot be restored.")
