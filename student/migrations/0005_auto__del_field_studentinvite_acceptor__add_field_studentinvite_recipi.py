...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentInvite.acceptor'
        db.delete_column('student_studentinvite', 'acceptor_id')

        # Adding field 'StudentInvite.recipient'
        db.add_column('student_studentinvite', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accepted_invite', unique=True, null=True, to=orm['student.Student']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'StudentInvite.acceptor'
        db.add_column('student_studentinvite', 'acceptor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accepted_invite', unique=True, null=True, to=orm['student.Student'], blank=True), keep_default=False)

        # Deleting field 'StudentInvite.recipient'
        db.delete_column('student_studentinvite', 'recipient_id')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 22, 18, 5, 55, 916000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 22, 18, 5, 55, 916000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.studentinvite': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 22, 18, 5, 55, 916000)', 'auto_now': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_invite_set'", 'to': "orm['student.Student']"}),
