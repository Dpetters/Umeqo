...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('student_studenttype', (
            ...
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 23, 9, 45, 5, 751000), auto_now=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 23, 9, 45, 5, 751000), auto_now_add=True, blank=True)),
        ...
        db.add_column('student_student', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.StudentType'], null=True, blank=True), keep_default=False)

        # Adding index on 'Student', fields ['first_name']
        db.create_index('student_student', ['first_name'])

        # Adding field 'StudentPreferences.receive_monthly_newsletter'
        db.add_column('student_studentpreferences', 'receive_monthly_newsletter', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing index on 'Student', fields ['first_name']
        db.delete_index('student_student', ['first_name'])

        # Deleting model 'StudentType'
        db.delete_table('student_studenttype')

        # Deleting field 'Student.type'
        db.delete_column('student_student', 'type_id')

        # Deleting field 'StudentPreferences.receive_monthly_newsletter'
        db.delete_column('student_studentpreferences', 'receive_monthly_newsletter')
    ...
    models = {
        ...
        'campus_org.campusorg': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 45, 5, 751000)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 45, 5, 751000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'student.student': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 45, 5, 845000)'}),
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.StudentType']", 'null': 'True', 'blank': 'True'}),
