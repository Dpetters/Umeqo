...
if "mailer" in settings.INSTALLED_APPS:
    from mailer import send_mail #@UnresolvedImport @UnusedImport
else:
    from django.core.mail import send_mail #@Reimport
...
def new_message_email(sender, instance, signal, #@UnusedVariable
