...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('core_language', ['name'])

        # Adding field 'Language.name_and_level'
        db.add_column('core_language', 'name_and_level', self.gf('django.db.models.fields.CharField')(default='temp', max_length=42), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Language.name_and_level'
        db.delete_column('core_language', 'name_and_level')

        # Adding unique constraint on 'Language', fields ['name']
        db.create_unique('core_language', ['name'])
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 13, 20, 56, 9, 477000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 13, 20, 56, 9, 476000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.edit': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 13, 20, 56, 9, 478000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
