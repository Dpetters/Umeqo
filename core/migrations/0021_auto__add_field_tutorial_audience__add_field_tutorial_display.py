...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tutorial.audience'
        db.add_column('core_tutorial', 'audience', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Tutorial.display'
        db.add_column('core_tutorial', 'display', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tutorial.audience'
        db.delete_column('core_tutorial', 'audience')

        # Deleting field 'Tutorial.display'
        db.delete_column('core_tutorial', 'display')
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 7, 13, 16, 47, 817000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 7, 13, 16, 47, 817000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.tutorial': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'Tutorial'},
            'audience': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 7, 13, 16, 47, 817000)', 'auto_now_add': 'True', 'blank': 'True'}),
