...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Course', fields ['ou']
        db.delete_unique('core_course', ['ou'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Course', fields ['ou']
        db.create_unique('core_course', ['ou'])
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 15, 28, 21, 129000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 15, 28, 21, 129000)', 'auto_now': 'True', 'blank': 'True'}),
