...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CampusOrgType.sort_order'
        db.add_column('core_campusorgtype', 'sort_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'EmploymentType.sort_order'
        db.add_column('core_employmenttype', 'sort_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CampusOrgType.sort_order'
        db.delete_column('core_campusorgtype', 'sort_order')

        # Deleting field 'EmploymentType.sort_order'
        db.delete_column('core_employmenttype', 'sort_order')
