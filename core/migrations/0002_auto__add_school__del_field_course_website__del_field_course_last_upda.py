...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_school', (
            ...
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 27, 0, 0), auto_now=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 27, 0, 0), auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=42)),
        ))
        db.send_create_signal('core', ['School'])

        # Deleting field 'Course.website'
        db.delete_column('core_course', 'website')

        # Deleting field 'Course.last_updated'
        db.delete_column('core_course', 'last_updated')
        ...
        # Deleting field 'Course.email'
        db.delete_column('core_course', 'email')

        # Deleting field 'Course.date_created'
        db.delete_column('core_course', 'date_created')

        # Deleting field 'Course.ou'
        db.delete_column('core_course', 'ou')

        # Deleting field 'Course.display'
        db.delete_column('core_course', 'display')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Course.website'
        db.add_column('core_course', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.last_updated'
        db.add_column('core_course', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 23, 11, 10, 15, 283000), auto_now=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Course.email'
        db.add_column('core_course', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.date_created'
        db.add_column('core_course', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 23, 11, 10, 15, 283000), auto_now_add=True, blank=True),
                      keep_default=False)
        ...
        db.add_column('core_course', 'display',
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 27, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 27, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
