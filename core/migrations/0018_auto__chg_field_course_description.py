...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_course', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.description'
        db.alter_column('core_course', 'description', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 9, 44, 15, 462000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 9, 44, 15, 462000)', 'auto_now': 'True', 'blank': 'True'}),
