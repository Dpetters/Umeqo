...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SchoolYear.name_plural'
        db.add_column('core_schoolyear', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=43, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SchoolYear.name_plural'
        db.delete_column('core_schoolyear', 'name_plural')
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 4, 17, 39, 58, 595000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 4, 17, 39, 58, 595000)', 'auto_now': 'True', 'blank': 'True'}),
