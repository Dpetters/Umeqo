...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainName.school'
        db.add_column('core_domainname', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.School'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainName.school'
        db.delete_column('core_domainname', 'school_id')
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
