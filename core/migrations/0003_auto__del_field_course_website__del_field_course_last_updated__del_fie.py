...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_course', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 22, 0, 0), auto_now=True, blank=True),
                      keep_default=False)
        ...
        db.add_column('core_course', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 22, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)
