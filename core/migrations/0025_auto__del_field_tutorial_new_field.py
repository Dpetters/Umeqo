...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Tutorial.new_field'
        raise RuntimeError("Cannot reverse this migration. 'Tutorial.new_field' and its values cannot be restored.")
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 12, 4, 28, 3, 619000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 12, 4, 28, 3, 619000)', 'auto_now': 'True', 'blank': 'True'}),
