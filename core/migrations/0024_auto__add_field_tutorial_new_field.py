...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tutorial.new_field'
        db.add_column('core_tutorial', 'new_field', self.gf('django.db.models.fields.CharField')(default='Hello', max_length=150), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tutorial.new_field'
        db.delete_column('core_tutorial', 'new_field')
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 16, 48, 7, 258000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 16, 48, 7, 258000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.tutorial': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 16, 48, 7, 258000)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'new_field': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '150', 'db_index': 'True'}),
            'sort_order': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '3'}),
