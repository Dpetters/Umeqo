...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tutorial.topic'
        db.add_column('core_tutorial', 'topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Topic'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tutorial.topic'
        db.delete_column('core_tutorial', 'topic_id')
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 7, 14, 0, 39, 532000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 7, 14, 0, 39, 532000)', 'auto_now': 'True', 'blank': 'True'}),
