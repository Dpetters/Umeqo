...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_employmenttype', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CampusOrgType.sort_order'
        db.alter_column('core_campusorgtype', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'EventType.sort_order'
        db.alter_column('core_eventtype', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Course.sort_order'
        db.alter_column('core_course', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Topic.sort_order'
        db.alter_column('core_topic', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Question.sort_order'
        db.alter_column('core_question', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tutorial.sort_order'
        db.alter_column('core_tutorial', 'sort_order', self.gf('django.db.models.fields.FloatField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tutorial.sort_order'
        db.alter_column('core_tutorial', 'sort_order', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))
    ...
    models = {
        ...
        'core.campusorgtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 4, 34, 595000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 4, 34, 595000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.edit': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 8, 14, 4, 34, 596000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
