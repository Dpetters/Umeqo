...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.admin'
        db.alter_column('core_course', 'admin', self.gf('django.db.models.fields.CharField')(max_length=42, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.admin'
        db.alter_column('core_course', 'admin', self.gf('django.db.models.fields.CharField')(max_length=41, null=True))
    ...
    models = {
        ...
        'core.question': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 6, 0, 37, 39, 59000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 6, 0, 37, 39, 59000)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'core.topic': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 6, 0, 37, 39, 58000)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 6, 0, 37, 39, 58000)', 'auto_now': 'True', 'blank': 'True'}),
